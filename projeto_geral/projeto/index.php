  ...
  <body>
    <nav class="navbar bg-light">
        <div class="container-fluid">
          <a class="nav-home" href="/projeto/index.php"><i class="fa fa-home"></i> Home</a>
        </div>
      </nav>
        ...
        <div class="col-sm-6">
          <div class="card m-3">
            <div class="card-body">
              ...
              <a href="/jogo/jogo.php" class="btn btn-primary">Acessar</a>
            </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="card m-3">
            <div class="card-body">
              ...
              <a href="/treinando_js/data.php" class="btn btn-primary">Acessar</a>
            </div>
          </div>
        </div>
      </div>
